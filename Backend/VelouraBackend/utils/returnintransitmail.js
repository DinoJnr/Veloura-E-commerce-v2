// mails/returns/returnintransitmail.js
// Trigger: Return status moves from approved → transit
//          (items are on their way back to Veloura)
// Message: We have confirmed your return shipment is on its way to us
...
const returnInTransitMail = async (order) => {
  const {
    customer,
    items = [],
    totalAmount,
    ...
    <div style="max-width:600px; margin:32px auto; background:#ffffff; border-radius:8px;
      ...
      <div style="background:#0d1b2a; padding:36px 32px; text-align:center;">
        ...
        <p style="color:rgba(201,169,110,0.7); font-size:10px; letter-spacing:0.28em;
                  text-transform:uppercase; margin:0;">Return In Transit</p>
      </div>
      ...
      <div style="background:#1a2a3a; padding:14px 32px; display:flex; align-items:center; gap:10px;">
        ...
        <span style="color:#a8c4e0; font-size:12px; letter-spacing:0.12em; text-transform:uppercase;">
          Your returned items are on their way to us
        </span>
      </div>
      ...
      <div style="padding:32px;">
        ...
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 12px;">
          We have confirmed that the returned items from your order
          <strong style="color:#0d1b2a;">#${orderId || "—"}</strong> are currently
          <strong style="color:#b8860b;">in transit</strong> back to our fulfilment centre.
          Your return is progressing smoothly.
        </p>
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 28px;">
          No further action is needed from you at this point. The moment your package arrives
          and our team completes inspection, we will send you a confirmation and begin
          processing your refund right away.
        </p>
        ...
        <div style="background:#f8f9fa; border-radius:8px; padding:20px 24px; margin-bottom:24px;">
          <p style="font-size:11px; color:#7a8dae; text-transform:uppercase; letter-spacing:0.14em;
                    margin:0 0 18px; font-weight:600;">Return progress</p>

          <!-- Step row helper: completed = gold dot, active = mid, pending = grey -->
          <table style="width:100%;" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style="text-align:center; width:25%; vertical-align:top;">
                ...
                <p style="font-size:10px; color:#aab4be; margin:0;">Submitted</p>
              </td>
              ...
              <td style="text-align:center; width:25%; vertical-align:top;">
                ...
                <p style="font-size:10px; color:#aab4be; margin:0;">Verified</p>
              </td>
              <td style="vertical-align:middle; padding-bottom:20px;">
                <div style="height:1.5px; background:#c9a96e;"></div>
              </td>
              <!-- In Transit — active -->
              <td style="text-align:center; width:25%; vertical-align:top;">
                <div style="width:28px; height:28px; border-radius:50%; background:#0d1b2a;
                            border:2px solid #c9a96e; margin:0 auto 6px;
                            display:flex; align-items:center; justify-content:center;">
                  <span style="color:#c9a96e; font-size:11px;">→</span>
                </div>
                <p style="font-size:11px; color:#0d1b2a; font-weight:700; margin:0 0 2px;">In Transit</p>
                <p style="font-size:10px; color:#7a8dae; margin:0;">Right now</p>
              </td>
              <td style="vertical-align:middle; padding-bottom:20px;">
                <div style="height:1.5px; background:#e8edf2;"></div>
              </td>
              <!-- Refunded — pending -->
              <td style="text-align:center; width:25%; vertical-align:top;">
                <div style="width:28px; height:28px; border-radius:50%; background:#e8edf2;
                            margin:0 auto 6px; display:flex; align-items:center; justify-content:center;">
                  <span style="color:#aab4be; font-size:13px;">↩</span>
                </div>
                <p style="font-size:11px; color:#aab4be; font-weight:500; margin:0 0 2px;">Refund</p>
                <p style="font-size:10px; color:#aab4be; margin:0;">Pending</p>
              </td>
            </tr>
          </table>
        </div>
        ...
        <table style="width:100%; margin-bottom:24px;" cellpadding="0" cellspacing="8">
          <tr>
            ...
            <td style="background:#fdf8ec; border-radius:4px; padding:8px 12px; width:25%;
                       border:0.5px solid #e8d5a0;">
              <span style="font-size:10px; color:#a07800; text-transform:uppercase;
                           letter-spacing:0.1em; display:block;">Return Status</span>
              <span style="font-size:13px; font-weight:500; color:#7a5800;">In Transit</span>
            </td>
            <td style="background:#f0f4f8; border-radius:4px; padding:8px 12px; width:25%;">
              <span style="font-size:10px; color:#7a8dae; text-transform:uppercase;
        ...
        <p style="font-size:11px; color:#7a8dae; text-transform:uppercase; letter-spacing:0.16em;
                  margin:0 0 14px; font-weight:500;">Items being returned</p>
          ...
          <tfoot>
            <tr style="border-top:1.5px solid #0d1b2a;">
              <td colspan="3" style="padding:14px 12px; text-align:right; font-size:12px;
                                     ...
                                     letter-spacing:0.12em; font-weight:500;">Expected Refund</td>
        ...
        <div style="background:#f8f9fa; border-radius:6px; padding:16px; margin-bottom:28px;
          ...
          <p style="font-size:13px; color:#0d1b2a; margin:0; line-height:1.75;">
            ✦ <strong>You are almost there.</strong> Once our team receives and inspects your
            items, your refund of <strong>${formatCurrency(totalAmount)}</strong> will be
            initiated within <strong>1–2 business days</strong>.
          </p>
        </div>
  ...
  return transporter.sendMail({
    ...
    to: customerEmail,
    subject: `Return In Transit — We Are Expecting Your Package #${orderId || "—"} | Veloura`,
    html,
  });
};

module.exports = { returnInTransitMail };