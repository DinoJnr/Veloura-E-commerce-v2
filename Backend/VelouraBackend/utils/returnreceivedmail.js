// mails/returns/returnreceivedmail.js
// Trigger: Return status moves from transit → received
//          (Veloura has physically received and signed for the returned package)
// Message: We have received your returned items and are inspecting them — refund coming soon
...
const returnReceivedMail = async (order) => {
  const {
    customer,
    items = [],
    totalAmount,
    ...
    <div style="max-width:600px; margin:32px auto; background:#ffffff; border-radius:8px;
      ...
      <div style="background:#0d1b2a; padding:36px 32px; text-align:center;">
        ...
        <p style="color:rgba(201,169,110,0.7); font-size:10px; letter-spacing:0.28em;
                  text-transform:uppercase; margin:0;">Return Received</p>
      </div>
      ...
      <div style="background:#1a3530; padding:14px 32px; display:flex; align-items:center; gap:10px;">
        ...
        <span style="color:#9fe1cb; font-size:12px; letter-spacing:0.12em; text-transform:uppercase;">
          Package received &amp; quality inspection underway
        </span>
      </div>
      ...
      <div style="padding:32px;">
        ...
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 12px;">
          We are pleased to confirm that we have <strong style="color:#1a4731;">received your
          returned package</strong> for order <strong style="color:#0d1b2a;">#${orderId || "—"}</strong>.
          Our quality team is currently inspecting the items to ensure everything is accounted for
          and in the expected condition.
        </p>
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 28px;">
          This is the final step before your refund is issued. You do not need to do anything —
          we will notify you as soon as your refund of
          <strong style="color:#0d1b2a;">${formatCurrency(totalAmount)}</strong> has been processed.
        </p>
        ...
        <div style="background:#f2fbf7; border:0.5px solid #a8d8bf; border-radius:8px;
          ...
          <p style="font-size:11px; color:#1a6040; text-transform:uppercase; letter-spacing:0.14em;
                    margin:0 0 12px; font-weight:600;">What we are doing right now</p>
          <table style="width:100%;" cellpadding="0" cellspacing="0">
            <tr>
              <td style="vertical-align:top; width:28px; padding-bottom:12px;">
                <span style="font-size:16px;">🔍</span>
              </td>
              <td style="vertical-align:top; padding-left:10px; padding-bottom:12px;">
                <p style="font-size:13px; font-weight:600; color:#0d1b2a; margin:0 0 3px;">Item inspection</p>
                <p style="font-size:12px; color:#5a6a7a; margin:0; line-height:1.65;">
                  Our team is checking each returned item for condition, completeness, and authenticity
            ...
            <tr>
              ...
              <td style="vertical-align:top; padding-left:10px;">
                ...
                <p style="font-size:12px; color:#5a6a7a; margin:0; line-height:1.65;">
                  Inspection is typically completed within <strong>1–2 business days</strong>.
                  Once done, your refund will be triggered immediately and you will receive
          ...
          <table style="width:100%;" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style="text-align:center; width:25%; vertical-align:top;">
                ...
                <p style="font-size:10px; color:#aab4be; margin:0;">Right now</p>
              </td>
              <td style="vertical-align:middle; padding-bottom:20px;">
              ...
              <td style="text-align:center; width:25%; vertical-align:top;">
                ...
                <p style="font-size:10px; color:#aab4be; margin:0;">Soon</p>
              </td>
            </tr>
          </table>
        </div>
        ...
        <p style="font-size:11px; color:#7a8dae; text-transform:uppercase; letter-spacing:0.16em;
                  margin:0 0 14px; font-weight:500;">Items received</p>
          ...
          <tfoot>
            <tr style="border-top:1.5px solid #0d1b2a;">
              <td colspan="3" style="padding:14px 12px; text-align:right; font-size:12px;
                                     ...
                                     letter-spacing:0.12em; font-weight:500;">Pending Refund</td>
        ...
        <div style="background:#f8f9fa; border-radius:6px; padding:16px; margin-bottom:28px;
          ...
          <p style="font-size:13px; color:#0d1b2a; margin:0; line-height:1.75;">
            ✦ <strong>Almost done.</strong> Sit tight — your refund of
            <strong>${formatCurrency(totalAmount)}</strong> is the very next step. We will
            email you the moment it has been issued.
          </p>
        </div>
  ...
  return transporter.sendMail({
    ...
    to: customerEmail,
    subject: `Return Received — Refund Coming Your Way #${orderId || "—"} | Veloura`,
    html,
  });
};

module.exports = { returnReceivedMail };