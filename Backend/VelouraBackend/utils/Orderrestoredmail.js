// mails/orderrestoredmail.js
// Trigger: A previously rejected order has been restored / reinstated
// Message: Your order has been restored and is now active again
...
const orderRestoredMail = async (order) => {
  const {
    customer,
    items = [],
    totalAmount,
    ...
    <div style="max-width:600px; margin:32px auto; background:#ffffff; border-radius:8px;
      ...
      <div style="background:#1a2a3a; padding:14px 32px; display:flex; align-items:center; gap:10px;">
        ...
        <span style="color:#a8c4e0; font-size:12px; letter-spacing:0.12em; text-transform:uppercase;">
          Your order has been reinstated &amp; is now active
        </span>
      </div>
      ...
      <div style="padding:32px;">
        ...
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 12px;">
          We have good news regarding your order <strong style="color:#0d1b2a;">#${orderId || "—"}</strong>.
          After a review, we are pleased to inform you that your previously rejected order has been
          <strong style="color:#1a3a5c;">successfully restored</strong> and reinstated into our system.
        </p>
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 24px;">
          Your order is now active and will proceed through our standard fulfilment process.
          We sincerely apologise for any disruption this may have caused, and we appreciate your
          patience with us.
        </p>
        ...
        <table style="width:100%; margin-bottom:24px;" cellpadding="0" cellspacing="8">
          <tr>
            ...
            <td style="background:#e8f0fb; border-radius:4px; padding:8px 12px; width:25%;
                       border:0.5px solid #b8cff0;">
              <span style="font-size:10px; color:#2c5282; text-transform:uppercase;
                           letter-spacing:0.1em; display:block;">Status</span>
              <span style="font-size:13px; font-weight:500; color:#1a3a6e;">Restored</span>
            </td>
            <td style="background:#f0f4f8; border-radius:4px; padding:8px 12px; width:25%;">
              <span style="font-size:10px; color:#7a8dae; text-transform:uppercase;
        ...
        <div style="background:#f8f9fa; border-radius:6px; padding:16px; margin-bottom:28px;
          ...
          <p style="font-size:13px; color:#5a6a7a; margin:0; line-height:1.75;">
            Your restored order will now be processed as normal. You will receive an update as it
            moves through each stage. No further action is required from your end — sit back and
  ...
  return transporter.sendMail({
    ...
    to: customerEmail,
    subject: `Order Restored — #${orderId || "—"} | Veloura`,
    html,
  });
};

module.exports = { orderRestoredMail };