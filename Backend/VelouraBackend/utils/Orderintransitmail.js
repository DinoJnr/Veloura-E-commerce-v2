// mails/orderintransitmail.js
// Trigger: Order status moves from accepted → transit
// Message: Your order has been processed and is set for transit
...
const orderInTransitMail = async (order) => {
  const {
    customer,
    items = [],
    totalAmount,
    ...
    <div style="max-width:600px; margin:32px auto; background:#ffffff; border-radius:8px;
      ...
      <div style="background:#1a2a3a; padding:14px 32px; display:flex; align-items:center; gap:10px;">
        ...
        <span style="color:#a8c4e0; font-size:12px; letter-spacing:0.12em; text-transform:uppercase;">
          Packed, sealed &amp; heading your way
        </span>
      </div>
      ...
      <div style="padding:32px;">
        ...
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 12px;">
          Your order <strong style="color:#0d1b2a;">#${orderId || "—"}</strong> has been fully processed,
          packaged with care, and is now <strong style="color:#b8860b;">set for transit</strong>.
          Our logistics partner has picked it up and it is on its way to you.
        </p>
        <p style="font-size:14px; color:#5a6a7a; line-height:1.7; margin:0 0 24px;">
          Please ensure someone is available to receive the delivery at your registered address.
          You will get a final notification once your order has been dispatched for last-mile delivery.
        </p>

        <!-- Delivery address callout -->
        <div style="background:#fffdf5; border:0.5px solid #e8d9a0; border-radius:6px;
                    padding:14px 16px; margin-bottom:24px;">
          <p style="font-size:10px; color:#7a8dae; text-transform:uppercase; letter-spacing:0.12em;
                    margin:0 0 6px; font-weight:500;">Delivering to</p>
          <p style="font-size:13px; color:#0d1b2a; margin:0; line-height:1.6;">
        ...
        <p style="font-size:11px; color:#7a8dae; text-transform:uppercase; letter-spacing:0.16em;
                  margin:0 0 14px; font-weight:500;">Items en route</p>
        ...
        <div style="background:#f8f9fa; border-radius:6px; padding:16px; margin-bottom:28px;
          ...
          <p style="font-size:13px; color:#0d1b2a; margin:0; line-height:1.75;">
            📦 <strong>Pro tip:</strong> Keep your phone reachable — our delivery partner may call
            ahead to confirm arrival. Make sure your gate or building reception is accessible.
          </p>
        </div>
  ...
  return transporter.sendMail({
    ...
    to: customerEmail,
    subject: `Your Order Is On Its Way — #${orderId || "—"} | Veloura`,
    html,
  });
};

module.exports = { orderInTransitMail };